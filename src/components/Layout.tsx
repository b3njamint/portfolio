...
export default function Layout() {
  ...
  const imageNames = ['image0.jpg', 'image1.jpg', 'image12.jpg'];
  const images = imageNames.map(name => require(`../images/art/${name}`));

  return (
    // <Box sx={{
    //   flexGrow: 1, backgroundColor: 'black', backgroundImage: `url(${grain})`
    // }}>
    //   <BokehBackground zIndex={-2} />
            ...
            <Grid item xs={12} md={12}>
              <Item className="click">
                <ContactButton
                  ...
                  description="Check out art.benjamint.me for more!" icon={undefined} />
              </Item>
            </Grid>
